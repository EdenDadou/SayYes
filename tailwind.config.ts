...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-custom":
          "linear-gradient(90deg, rgba(27, 27, 27, 0.00) -3.01%, rgba(222, 254, 145, 0.04) 24.73%, rgba(181, 239, 255, 0.12) 49.8%, rgba(220, 196, 255, 0.12) 73.8%, rgba(27, 27, 27, 0.00) 102.68%)",
      },
      boxShadow: {
