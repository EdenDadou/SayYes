...
const SvgSmile = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g filter="url(#filter0_bd_2993_3897)">
      ...
      />
      <path
        d="M6.15 12.4336C6.15 9.2077 8.77411 6.58359 12 6.58359C15.2259 6.58359 17.85 9.2077 17.85 12.4336C17.85 15.6595 15.2259 18.2836 12 18.2836C8.77411 18.2836 6.15 15.6595 6.15 12.4336ZM7.76061 12.4336C7.76061 14.7716 9.66203 16.673 12 16.673C14.338 16.673 16.2394 14.7716 16.2394 12.4336C16.2394 12.0711 15.9451 11.7768 15.5826 11.7768C15.2202 11.7768 14.9259 12.0711 14.9259 12.4336C14.9259 14.0466 13.613 15.3595 12 15.3595C10.387 15.3595 9.07413 14.0466 9.07413 12.4336C9.07413 12.0711 8.77984 11.7768 8.41737 11.7768C8.0549 11.7768 7.76061 12.0711 7.76061 12.4336Z"
        stroke="white"
        strokeOpacity={0.7}
        strokeWidth={0.3}
        style={{
