...
interface MasqueMobileProps extends SVGProps<SVGSVGElement> {
  fullscreen?: boolean;
}

const MasqueMobile = ({ fullscreen = false, ...props }: MasqueMobileProps) => (
  <svg
    width="100%"
    height="100%"
    fill="none"
    ...
    {...props}
  >
    <g clipPath="url(#clip0_911_6497)">
      {/* <rect
        y={528}
        width={528}
        height={334}
        rx={9.2455}
        transform="rotate(-90 0 528)"
        fill="black"
      /> */}
      <g clipPath="url(#clip1_911_6497)">
        <g filter="url(#filter0_f_911_6497)">
          <path
            ...
            fill="url(#paint0_linear_911_6497)"
          />
        </g>
      </g>
    </g>
    <defs>
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation={163.65}
          result="effect1_foregroundBlur_911_6497"
        />
      </filter>
      <linearGradient
        id="paint0_linear_911_6497"
        x1={-65.7553}
        y1={579.52}
        x2={357.521}
        y2={521.942}
      ...
      <clipPath id="clip1_911_6497">
        <rect
          ...
          height={342.67}
          fill="white"
          transform="translate(-6.36523 533.304) rotate(-90)"
        />
      </clipPath>
    </defs>
  </svg>
