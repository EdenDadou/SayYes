...
import SvgBackgroundModal from "./BackgroundModal";
...
import SvgArrowFull from "~/assets/icons/ArrowFull";
          ...
          <div className="relative z-10 w-[55%] flex flex-col justify-center gap-10">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-3xl md:text-5xl font-bold text-white font-jakarta-bold">
                  Une idée, un projet,{" "}
                </p>
                <p className="text-3xl md:text-5xl font-bold text-white font-jakarta-bold">
                  un évènement ?
                </p>
                <h1 className="text-3xl md:text-5xl font-bold text-white flex flex-row items-center gap-4 font-jakarta-bold leading-tight holographic-text mt-2">
