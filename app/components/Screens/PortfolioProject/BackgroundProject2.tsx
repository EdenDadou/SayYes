...
const BackgroundProject2 = memo(function BackgroundProject2(
  ...
  // Sinon, utiliser le SVG avec filtres SVG (pour que Canvas puisse les rendre)
  return (
    <svg
      ref={svgRef}
    ...
    >
      ...
      <g clipPath="url(#bg2-clip)">
        <g filter={isMobile ? "url(#bg2-filter0)" : undefined}>
          <path
            ...
            style={
              !isMobile
                ? {
                    filter: `blur(${43.65 * blurScale}px)`,
                    WebkitFilter: `blur(${43.65 * blurScale}px)`,
                  }
                : undefined
            }
          />
        </g>
        <g filter={isMobile ? "url(#bg2-filter1)" : undefined}>
          {/* Ce path hérite fill="white" du SVG parent */}
          <path
            d="M-227.446 310.023C-200.079 99.1226 -63.2192 547.411 582.628 709.222C1112.55 861.753 1506.91 540.975 1479.55 751.875C1452.18 962.775 1094.21 1519.74 505.471 1370.51C-83.2688 1221.28 -254.812 520.923 -227.446 310.023Z"
            style={
              !isMobile
                ? {
                    filter: `blur(${68.65 * blurScale}px)`,
                    WebkitFilter: `blur(${68.65 * blurScale}px)`,
                  }
                : undefined
            }
          />
        </g>
        <g filter={isMobile ? "url(#bg2-filter2)" : undefined}>
          <path
      ...
      <defs>
        ...
        {/* Filtres SVG pour mobile (utilisés pour générer le PNG) */}
        {isMobile && (
          <>
            <filter
              id="bg2-filter0"
