...
const cards = [
  {
    ...
    cta: <SvgCardYellowCta className="cursor-pointer w-40 pt-2" />,
    bg: (
      <img
        loading="lazy"
        src="images/section2/cardBg.png"
        alt="bg"
        className="relative"
      />
    ),
  ...
  },
  {
    ...
    cta: <SvgCardPinkCta className="cursor-pointer w-40 pt-2" />,
    bg: (
      <img
        loading="lazy"
        src="images/section2/cardBg.png"
  ...
  },
  {
    ...
    cta: <SvgCardBlueCta className="cursor-pointer w-40 pt-2" />,
    bg: (
      <img
        loading="lazy"
        src="images/section2/cardBg.png"
