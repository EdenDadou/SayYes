...
export default function CardMobile({
  ...
  return (
    ...
    >
      <motion.div
        className="relative transform-origin-top flex w-full justify-center items-center h-full"
        style={{ scale, willChange: "transform" }}
      >
        {bg}
        <div className="absolute flex flex-col justify-center items-center gap-6 w-full h-fit px-10 py-20">
          {logo}
          {title}
