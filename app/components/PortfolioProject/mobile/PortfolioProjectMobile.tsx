...
export default function PortfolioProjectMobile({
  ...
  return (
    <MobileLayout>
      ...
      /> */}
      <main className="w-screen h-fit relative pb-20 overflow-hidden">
        {/* Main Content */}
        <div className="relative z-10 pt-12 flex flex-col ">
            ...
            <div className="flex flex-row justify-between items-end pl-16">
              <div className="flex flex-col gap-12 items-center">
                ...
                <div className="flex flex-col items-center">
                  {portfolio.topTitle ? (
                    <p
                      className="text-4xl text-white flex flex-row items-center
                  font-jakarta-bold mb-2 gap-4"
                    >
                      {portfolio.topTitle}
                  ...
                  <h1
                    className="text-4xl font-bold text-white flex flex-row items-center gap-6 font-jakarta-bold"
          ...
          {/* Content Grid */}
          <section className="flex flex-col gap-16 py-12 bg-white px-8">
            {/* Description */}
          ...
          {/* Deliverables */}
          <div className="flex flex-col items-start justify-between w-full px-4 bg-white py-12">
            <h3 className=" flex flex-row items-center gap-2 text-2xl text-black mb-6 font-jakarta-bold">
              <Star className="w-6 h-6" fill="black" />
              Nos Livrables
            </h3>
            <div className="flex flex-row flex-nowrap gap-6 w-screen overflow-x-scroll scrollbar-hide">
              {portfolio.livrable.map((item: string, index: number) => (
                <span
                  key={index}
                  className="flex flex-row items-center justify-center gap-2 px-3 py-3 rounded-full text-sm border font-jakarta-bold whitespace-nowrap"
                  style={{
          ...
          <section className="mb-16 relative px-4">
            ...
            <div className="relative z-50">
              <h2 className="flex flex-col justify-center items-center gap-2 text-[26px] font-bold text-black font-jakarta-bold mb-12 z-50">
