...
import SvgFlamme from "~/components/OldHeader/components/Flamme";
import SvgCoeur from "~/components/OldHeader/components/Coeur";
import SvgSmile from "~/components/OldHeader/components/Smile";
import SvgLight from "~/components/OldHeader/components/Light";
import SvgCtaParlonsDesign from "~/components/OldHeader/components/CtaParlonsDesign";
