...
INSERT INTO "new_portfolios" ("bento", "createdAt", "description", "id", "kicker", "livrable", "photoCouverture", "slug", "sousTitre", "titre", "updatedAt") SELECT "bento", "createdAt", "description", "id", "kicker", "livrable", "photoCouverture", "slug", "sousTitre", "titre", "updatedAt" FROM "portfolios";
